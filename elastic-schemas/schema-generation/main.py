...
def main():
    for schema in schemas:
        ...
        full_index = {
            ...
            "mappings": {"dynamic": "false", "properties": mapping_result},
        }
        ...
        for property_name in json_schema.get("properties"):
            ...
            if json_property.get("type") == "array":
                ...
                if items.get("$ref"):
                    ...
                    mapping[property_name] = {"properties": nested_properties}
...
def generate_property_mapping(json_property):
    ...
    if json_property.get("enum"):
        ...
        return {"type": "constant_keyword", "value": json_property.get("const")}
    elif json_property.get("format") and json_property.get("format") == "date-time":
        return {"type": "date"}
